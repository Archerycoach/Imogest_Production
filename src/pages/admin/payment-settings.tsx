...
import { CreditCard, Smartphone, Save, Eye, EyeOff, AlertCircle, CheckCircle2 } from "lucide-react";
...
export default function PaymentSettingsPage() {
  ...
  const loadConfig = async () => {
    try {
      // Load from localStorage (in production, use database)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto p-6 max-w-5xl">
        <div className="mb-6">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Configurações de Pagamento</h1>
